...
class ProfileWallTableViewCell: UITableViewCell {
    ...
    func setValues(model: Post,topViewClosure: (() -> Void)?, completion: ((Bool) -> Void)?, handler: (() -> Void)?) {
        model.copyHistory != nil ? setupRepostViewConstraints() : setupLowViewConstraints()
        ...
        if let history = model.copyHistory {
